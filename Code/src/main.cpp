...
int main ()
{
  ...
  material_ambient->data.push_back ({0.2f, 0.0f, 0.8f, 1.0f});                                      // Initializing material ambient color [r, g, b, transparency]...
  material_ambient->data.push_back ({0.8f, 0.2f, 0.2f, 1.0f});                                      // Initializing material ambient color [r, g, b, transparency]...
