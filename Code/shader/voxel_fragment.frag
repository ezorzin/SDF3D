...
void main()
{
  ...
  light.ref = pow(max(dot(N, halfway), 0.0f), M.sh);                                                // Computing light reflected intensity
  ...
  light.ref_col = light.ref*light.col*M.ref_col;                                                    // Computing light reflected color...
