...
void main()
{
  ...
  sdf_L = INF;
  sdf_R = INF;
  sdf_L = min(sdf_L, SDF_plane(ray - dy));                                      // Computing signed distance field...
  sdf_L = min(sdf_L, SDF_sphere(ray - dy));                                     // Computing signed distance field...
  sdf_R = min(sdf_R, SDF_plane(ray + dy));                                      // Computing signed distance field...
  sdf_R = min(sdf_R, SDF_sphere(ray + dy));                                     // Computing signed distance field...
  ny = sdf_R - sdf_L;                      

  sdf_L = INF;
  sdf_R = INF;
  sdf_L = min(sdf_L, SDF_plane(ray - dz));                                      // Computing signed distance field...
  sdf_L = min(sdf_L, SDF_sphere(ray - dz));                                     // Computing signed distance field...
  sdf_R = min(sdf_R, SDF_plane(ray + dz));                                      // Computing signed distance field...
  sdf_R = min(sdf_R, SDF_sphere(ray + dz));                                     // Computing signed distance field...
  nz = sdf_R - sdf_L;                      
